(ns iotivity.example.discovery.server.controller
  (:require [iotivity.example.discovery.server.config :as config]
            [iotivity.example.discovery.server.light  :as light])
